...
| CHIRPSTACK_DOWNLINK_ACK_TOPIC_TEMPLATE |          | gateway/{}/command/down | ChirpStack downlink ack topic template. The single positional variable will be subsituted with CHIRPSTACK_GATEWAY_ID                                                                  |
